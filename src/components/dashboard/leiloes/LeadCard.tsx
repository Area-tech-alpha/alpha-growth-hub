...
export const LeadCard = ({ lead, onSelect }: LeadCardProps) => {
    ...
    const getTimeColor = () => {
        if (lead.timeLeft <= 60) return 'text-foreground';
        if (lead.timeLeft <= 180) return 'text-yellow-600 dark:text-yellow-400';
    ...
    return (
        <Card className="hover:shadow-lg transition-all duration-200 border border-border bg-card text-card-foreground hover:border-yellow-300">
            ...
            <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 pt-2">
                    <div className="text-center">
                        <div className="text-lg font-bold text-yellow-600">R$ {lead.currentBid}</div>
