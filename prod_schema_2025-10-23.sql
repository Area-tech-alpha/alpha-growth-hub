...
\restrict trVQKsCgTtQpJf0l2oillhw1n0N4CTjknp8KoHfGfRJjBD7OTBw5abdwm1Sfxel
...
--
-- Name: credit_hold_status_enum; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: credit_source_enum; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: after_lead_change_create_auction(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.after_lead_change_create_auction() RETURNS trigger
    LANGUAGE plpgsql
    AS $$DECLARE
...
--
-- Name: before_lead_change_set_status(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.before_lead_change_set_status() RETURNS trigger
    LANGUAGE plpgsql
    AS $$DECLARE
  v_category CHAR(1);
BEGIN
...
--
-- Name: credit_transactions_fill_source(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.credit_transactions_fill_source() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: enqueue_credit_job(text, jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.enqueue_credit_job(p_asaas_payment_id text, p_payload jsonb) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
...
--
-- Name: FUNCTION enqueue_credit_job(p_asaas_payment_id text, p_payload jsonb); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: get_user_active_credit_holds(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_user_active_credit_holds(p_user_id text) RETURNS numeric
    LANGUAGE sql
    AS $$
...
--
-- Name: get_user_credit_balance(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_user_credit_balance(p_user_id text DEFAULT NULL::text) RETURNS numeric
    LANGUAGE sql
    AS $$
...
--
-- Name: get_user_credit_transactions(text, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_user_credit_transactions(p_user_id text, p_limit integer DEFAULT 5) RETURNS SETOF public.credit_transactions
    LANGUAGE sql
    AS $$
  select ct.*
...
--
-- Name: get_user_leads(text, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_user_leads(p_user_id text, p_limit integer DEFAULT 100) RETURNS SETOF public.leads
    LANGUAGE sql
    AS $$
  select l.*
  from public.leads l
...
--
-- Name: grant_credits_on_payment(text, text, numeric, jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.grant_credits_on_payment(p_asaas_payment_id text, p_user_id text, p_credits_purchased numeric, p_metadata jsonb) RETURNS bigint
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public', 'extensions'
    AS $$
DECLARE
...
--
-- Name: FUNCTION grant_credits_on_payment(p_asaas_payment_id text, p_user_id text, p_credits_purchased numeric, p_metadata jsonb); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: grant_credits_on_payment_generic(text, text, text, numeric, jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.grant_credits_on_payment_generic(p_provider text, p_payment_id text, p_user_id text, p_credits_purchased numeric, p_metadata jsonb) RETURNS bigint
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_transaction_id BIGINT;
...
--
-- Name: ledger_entries_fill_credit_source(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.ledger_entries_fill_credit_source() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
...
--
-- Name: prevent_expired_bids(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.prevent_expired_bids() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin
  if exists (
...
--
-- Name: process_credit_jobs_worker(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.process_credit_jobs_worker() RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE
    job RECORD;
...
--
-- Name: FUNCTION process_credit_jobs_worker(); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: trigger_auction_on_lead_change(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.trigger_auction_on_lead_change() RETURNS trigger
    LANGUAGE plpgsql
    AS $$DECLARE
...
--
-- Name: a_credit_jobs; Type: TABLE; Schema: pgmq; Owner: -
--

CREATE TABLE pgmq.a_credit_jobs (
...
--
-- Name: q_credit_jobs; Type: TABLE; Schema: pgmq; Owner: -
--

CREATE TABLE pgmq.q_credit_jobs (
    msg_id bigint NOT NULL,
    read_ct integer DEFAULT 0 NOT NULL,
    enqueued_at timestamp with time zone DEFAULT now() NOT NULL,
    vt timestamp with time zone NOT NULL,
...
--
-- Name: q_credit_jobs_msg_id_seq; Type: SEQUENCE; Schema: pgmq; Owner: -
--

ALTER TABLE pgmq.q_credit_jobs ALTER COLUMN msg_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME pgmq.q_credit_jobs_msg_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: credit_holds_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.credit_holds_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: credit_holds_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: google_chat_webhook_logs; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.google_chat_webhook_logs (
    id bigint NOT NULL,
    auction_id uuid,
    payload_text text,
    status integer,
...
--
-- Name: google_chat_webhook_logs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.google_chat_webhook_logs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: google_chat_webhook_logs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: lead_counter_a; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.lead_counter_a
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 15
...
--
-- Name: lead_counter_b; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.lead_counter_b
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 13
...
--
-- Name: lead_counter_c; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.lead_counter_c
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 7
...
--
-- Name: TABLE processed_webhooks; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: request_keys; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: v_lead_count; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.v_lead_count (
    nextval bigint
);
...
--
-- Name: credit_holds id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: google_chat_webhook_logs id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: a_credit_jobs a_credit_jobs_pkey; Type: CONSTRAINT; Schema: pgmq; Owner: -
--

ALTER TABLE ONLY pgmq.a_credit_jobs
    ADD CONSTRAINT a_credit_jobs_pkey PRIMARY KEY (msg_id);


--
-- Name: q_credit_jobs q_credit_jobs_pkey; Type: CONSTRAINT; Schema: pgmq; Owner: -
--

ALTER TABLE ONLY pgmq.q_credit_jobs
    ADD CONSTRAINT q_credit_jobs_pkey PRIMARY KEY (msg_id);
...
--
-- Name: auctions auctions_winning_bid_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: checkout_sessions checkout_sessions_asaas_checkout_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: credit_holds credit_holds_user_auction_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: credit_transactions credit_transactions_asaas_payment_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: credit_transactions credit_transactions_infinitepay_payment_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: google_chat_webhook_logs google_chat_webhook_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: Account provider_unique_id; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: request_keys request_keys_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: VerificationToken token_identifier_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: archived_at_idx_credit_jobs; Type: INDEX; Schema: pgmq; Owner: -
--

CREATE INDEX archived_at_idx_credit_jobs ON pgmq.a_credit_jobs USING btree (archived_at);


--
-- Name: q_credit_jobs_vt_idx; Type: INDEX; Schema: pgmq; Owner: -
--

CREATE INDEX q_credit_jobs_vt_idx ON pgmq.q_credit_jobs USING btree (vt);
...
--
-- Name: auctions_lead_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: bids_auction_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: bids_user_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_auctions_status_expired_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bids_auction_id_created_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_checkout_sessions_user_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_credit_holds_auction_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_credit_holds_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_credit_holds_user_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ledger_entries_transaction_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ledger_entries_user_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: uniq_credit_tx_reward_idempotency; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: leads after_lead_change_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER after_lead_change_trigger AFTER INSERT OR UPDATE ON public.leads FOR EACH ROW EXECUTE FUNCTION public.after_lead_change_create_auction();


--
-- Name: leads before_lead_change_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER before_lead_change_trigger BEFORE INSERT ON public.leads FOR EACH ROW EXECUTE FUNCTION public.before_lead_change_set_status();


--
-- Name: auctions on-add-new-auction-google-chat; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "on-add-new-auction-google-chat" AFTER INSERT ON public.auctions FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://nfwfolrcpaxqwgkzzfok.supabase.co/functions/v1/rapid-service', 'POST', '{"Content-type":"application/json","x-webhook-secret":"aAyVo2Ak94F7Myfv2A"}', '{}', '10000');


--
-- Name: credit_transactions trg_credit_transactions_fill_source; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_credit_transactions_fill_source BEFORE INSERT ON public.credit_transactions FOR EACH ROW EXECUTE FUNCTION public.credit_transactions_fill_source();


--
-- Name: ledger_entries trg_ledger_entries_fill_credit_source; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_ledger_entries_fill_credit_source BEFORE INSERT ON public.ledger_entries FOR EACH ROW EXECUTE FUNCTION public.ledger_entries_fill_credit_source();


--
-- Name: bids trg_prevent_expired_bids; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_prevent_expired_bids BEFORE INSERT ON public.bids FOR EACH ROW EXECUTE FUNCTION public.prevent_expired_bids();
...
--
-- Name: auctions auctions_lead_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: checkout_sessions checkout_sessions_user_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: credit_holds credit_holds_auction_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: credit_holds credit_holds_bid_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: auctions fk_winning_bid; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: auctions Allow authenticated users to interact with auctions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: leads Allow authenticated users to interact with leads; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: bids Allow authenticated users to place bids; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: ledger_entries Allow user to read their own ledger entries; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: credit_transactions Allow user to read their own transactions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: leads TEST - Allow authenticated users to read all leads.; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: auctions; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.auctions ENABLE ROW LEVEL SECURITY;

--
-- Name: auctions auctions_select_all_statuses; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: auctions auctions_select_open; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: bids bids_insert_self; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: bids bids_select_all_auth; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: bids bids_select_open_or_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: credit_holds credit_holds_select_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: bids insert bids for open auctions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: bids insert bids only for open & unexpired auctions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: leads leads_select_owned; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: leads leads_select_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: bids read bids for open auctions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: leads read leads for open auctions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: auctions read open auctions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: auctions read_auctions_for_own_holds; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: credit_holds read_own_holds; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: credit_holds select_own_credit_holds; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: users select_own_credits; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: credit_transactions select_own_transactions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime auctions; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime bids; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime credit_holds; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.credit_holds;


--
-- Name: supabase_realtime credit_transactions; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
\unrestrict trVQKsCgTtQpJf0l2oillhw1n0N4CTjknp8KoHfGfRJjBD7OTBw5abdwm1Sfxel
